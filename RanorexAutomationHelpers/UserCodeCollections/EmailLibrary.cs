        ...
        [UserCodeMethod]
                ...
                string password = "")
            {
                try
                {
                    ...
                    {
                        Credentials = new NetworkCredential("berkant000@gmail.com", "19041997"),
                        EnableSsl = true,
                    };

                    to = to.Replace(";", ",");
                    var message = new MailMessage("berkant000@gmail.com", "ayarberkant@gmail.com")
                    {
                        Subject = "Hello from Ranorex",
                        Body = "Try Send Email from Ranorex"
                    };
